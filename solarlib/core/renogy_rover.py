...
2022,11,20 - Updated for use with minimalmodbus v2.01
"""
...
class RenogyRover(minimalmodbus.Instrument):
    ...
    def system_voltage_current(self):
        """
        Read the controller's maximum system voltage and charging current
    ...
    def system_discharge_type(self):
        """
        Read the controller's rated discharging current and product type
    ...
    def model(self):
        ...
        """
        return self.read_string(12, number_of_registers=8).strip()
    ...
    def high_voltage_disconnect(self):
        ...
        """
        register = self.read_register(57349, number_of_decimals=1)
        return register
    ...
    def charge_limit_voltage(self):
        ...
        """
        register = self.read_register(57350, number_of_decimals=1)
        return register

    def equalize_charge_voltage(self):
        """
        Read equalize charge voltage setting of the controller
        """
        register = self.read_register(57351, number_of_decimals=1)
        return register
    ...
    def float_charge_voltage(self):
        ...
        """
        register = self.read_register(57353, number_of_decimals=1)
        return register
    ...
    def boost_charge_return_voltage(self):
        ...
        """
        register = self.read_register(57354, number_of_decimals=1)
        return register
    ...
    def over_discharge_return_voltage(self):
        ...
        """
        register = self.read_register(57355, number_of_decimals=1)
        return register
    ...
    def low_voltage_alarm(self):
        ...
        """
        register = self.read_register(57356, number_of_decimals=1)
        return register
    ...
    def over_discharge_voltage(self):
        ...
        """
        register = self.read_register(57357, number_of_decimals=1)
        return register
    ...
    def discharge_limit_voltage(self):
        ...
        """
        register = self.read_register(57358, number_of_decimals=1)
        return register
    ...
    def equalize_charge_time(self):
        """
        Read equalize charge time (in minutes) setting of the controller
        """
    ...
    def equalize_charge_interval(self):
        """
        Read equalize charge interval (in days) setting of the controller
        """
